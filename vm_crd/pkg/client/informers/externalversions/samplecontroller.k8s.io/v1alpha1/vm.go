...
import (
	...
	v1alpha1 "vm_crd/pkg/client/listers/samplecontroller.k8s.io/v1alpha1"
	"context"
	time "time"

	samplecontrollerk8siov1alpha1 "vm_crd/pkg/apis/samplecontroller.k8s.io/v1alpha1"
...
func NewFilteredVMInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&samplecontrollerk8siov1alpha1.VM{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vMInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollerk8siov1alpha1.VM{}, f.defaultInformer)
}
